...
<table id="dg" title="博客类别管理" class="easyui-datagrid" 
  ...
  url="${pageContext.request.contextPath}/admin/blogType/list.html" fit="true" toolbar="#tb">
  <thead>
  	<tr>
	...
	<form id="fm" method="post">
		<table cellspacing="8px">
			...
			<tr>
				<td>博客类别排序：</td>
				<td>
					<input type="text" id="orderNum" name="orderNum" class="easyui-numberbox" required="true" style="width: 60px"/>&nbsp;(类别根据排序序号从小到大排序)
				</td>
			</tr>
		</table>
	</form>
